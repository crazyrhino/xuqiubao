                    ...
                    case 1:   //省级
                        {
                            ...
                            //市级相关处理
                            dataHanlder.city();
                            console.log(JSON.stringify(currentProvince));
                            provinceId = currentProvince.code;
                        }
                        break;
                    case 2: //市级
                        {
                    ...
                    case 3://区县
                        {
                            ...
                            $area.hide();
                            dataHanlder.town();
                            console.log(JSON.stringify(currentArea));
                            regionId = currentArea.code;
